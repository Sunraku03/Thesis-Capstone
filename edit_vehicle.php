...
<div class="form-card">
    ...
    <form method="post" enctype="multipart/form-data">
        <?php switch ($section):
            ...
            case 'edit_collection':
                foreach (["first_payment", "second_payment", "third_payment", "fourth_payment", "fifth_payment", "sixth_payment", "payment_status", "end_date", "ctpl", "bank_status", "remarks"] as $field): ?>
                    <input type="text" name="<?= $field ?>" value="<?= htmlspecialchars($client[$field]) ?>" class="form-control mb-3" placeholder="<?= ucwords(str_replace("_", " ", $field)) ?>">
                <?php endforeach; break;
        endswitch; ?>
